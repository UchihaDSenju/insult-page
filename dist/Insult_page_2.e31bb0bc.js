...
downloadBtn.addEventListener('click', function () {
  console.log('clicked');
  var screenshotTarget = document.querySelector('.container');
  ...
  _toastr.default["success"]("This is the message", "Hello");
...
function insult() {
  ...
  console.log(insult);
  fetch('insults.json').then(function (res) {
    return res.json();
  }).then(function (data) {
    buttons.style.display = 'flex';
    console.log(data);
    var num = parseInt(Math.random() * data['insults'].length);
    console.log(num);
